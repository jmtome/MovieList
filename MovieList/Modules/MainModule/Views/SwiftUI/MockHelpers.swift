...
//  MovieList
//
//  Created by Juan Manuel Tome on 19/09/2024.
//
import MovieListFramework

struct MocchyItems {
    static func expectedItems(at index: Int) -> MediaItem {
    ...
    static func adult(at index: Int) -> Bool {
        return [
            false,
            false,
            false,
    ...
    static func backdropPath(at index: Int) -> String? {
        return [
    ...
    static func genreIds(at index: Int) -> [Int] {
        return [
            [28, 878, 27],
            [35, 12, 14],
            [27, 9648, 53],
    ...
    static func id(at index: Int) -> Int {
        return [
            615656,
            346698,
            968051,
    ...
    static func mediaType(at index: Int) -> String? {
        return nil
    }
    static func originalLanguage(at index: Int) -> String {
        return [
            "en",
            "en",
            "en",
    ...
    static func originalTitle(at index: Int) -> String {
        return [
            "Meg 2: The Trench",
            "Barbie",
            "The Nun II",
    ...
    static func overview(at index: Int) -> String {
        return [
    ...
    static func popularity(at index: Int) -> Double {
        return [
            5133.953,
            3712.487,
            2536.981,
    ...
    static func posterPath(at index: Int) -> String? {
        return [
            "https://image.tmdb.org/t/p/w154//4m1Au3YkjqsxF8iwQy0fPYSxE0h.jpg",
            "https://image.tmdb.org/t/p/w154//iuFNMS8U5cb6xfzi51Dbkovj7vM.jpg",
            "https://image.tmdb.org/t/p/w154//5gzzkR7y3hnY8AD1wXjCnVlHba5.jpg",
            "https://image.tmdb.org/t/p/w154//Af4bXE63pVsb2FtbW8uYIyPBadD.jpg",
            "https://image.tmdb.org/t/p/w154//6oH378KUfCEitzJkm07r97L0RsZ.jpg",
            "https://image.tmdb.org/t/p/w154//n1hqbSCtyBAxaXEl1Dj3ipXJAJG.jpg",
            "https://image.tmdb.org/t/p/w154//ueO9MYIOHO7M1PiMUeX74uf8fB9.jpg",
            "https://image.tmdb.org/t/p/w154//kSf9svfL2WrKeuK8W08xeR5lTn8.jpg",
            "https://image.tmdb.org/t/p/w154//1H2xEZOixs0z0JKwyjANZiKNNVJ.jpg",
            "https://image.tmdb.org/t/p/w154//gPbM0MK8CP8A174rmUwGsADNYKD.jpg",
            "https://image.tmdb.org/t/p/w154//8Vt6mWEReuy4Of61Lnj5Xj704m8.jpg",
            "https://image.tmdb.org/t/p/w154//nrtbv6Cew7qC7k9GsYSf5uSmuKh.jpg",
            "https://image.tmdb.org/t/p/w154//sFC1ElvoKGdHJIWRpNB3xWJ9lJA.jpg",
            "https://image.tmdb.org/t/p/w154//rktDFPbfHfUbArZ6OOOKsXcv0Bm.jpg",
            "https://image.tmdb.org/t/p/w154//fiVW06jE7z9YnO4trhaMEdclSiC.jpg",
            "https://image.tmdb.org/t/p/w154//vB8o2p4ETnrfiWEgVxHmHWP9yRl.jpg",
            "https://image.tmdb.org/t/p/w154//ym1dxyOk4jFcSl4Q2zmRrA5BEEN.jpg",
            "https://image.tmdb.org/t/p/w154//mcz8oi9oCgq1wkA3Wz2kluE94pE.jpg",
            "https://image.tmdb.org/t/p/w154//d07phJqCx6z5wILDYqkyraorDPi.jpg",
            "https://image.tmdb.org/t/p/w154//1kdmre0wlUAUk9BvySv4Xoveieg.jpg",
        ][index]
    }
    static func releaseDate(at index: Int) -> String {
        return [
            "2023-08-02",
            "2023-07-19",
            "2023-09-06",
    ...
    static func video(at index: Int) -> Bool {
        return [
            false,
            false,
            false,
    ...
    static func voteAverage(at index: Int) -> Double {
        return [
            7.0,
            7.3,
            6.9,
    ...
    static func voteCount(at index: Int) -> Int {
        return [
            1595,
            4060,
            85,
